        ...
        <div class="modal fade" id="editModal{{ $vehicle->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 rounded-4 overflow-hidden">
                    ...
                    <form method="POST" action="{{ route('editVehicle', $vehicle->id) }}" class="needs-validation"
                        novalidate>
                        @csrf
                        <div class="modal-body px-4 py-4">
                            <div class="row g-3">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="plate" class="form-control form-control-sm py-2"
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="brand" class="form-control form-control-sm py-2"
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="model" class="form-control form-control-sm py-2"
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="number" name="year" class="form-control form-control-sm py-2"
                                        value="{{ $vehicle->year }}" placeholder="2024" min="1900" max="2099"
                                        required />
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="type" class="form-select form-select-sm py-2" required>
                                        <option value="Sedan" {{ $vehicle->type == 'Sedan' ? 'selected' : '' }}>Sedan
                                        </option>
                                        <option value="SUV" {{ $vehicle->type == 'SUV' ? 'selected' : '' }}>SUV</option>
                                        <option value="Truck" {{ $vehicle->type == 'Truck' ? 'selected' : '' }}>Truck
                                        </option>
                                        <option value="Van" {{ $vehicle->type == 'Van' ? 'selected' : '' }}>Van</option>
                                        <option value="Motorcycle" {{ $vehicle->type == 'Motorcycle' ? 'selected' : '' }}>
                                            Motorcycle</option>
                                    </select>
                                </div>
                            </div>
